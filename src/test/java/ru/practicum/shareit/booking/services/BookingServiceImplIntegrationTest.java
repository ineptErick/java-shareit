...
public class BookingServiceImplIntegrationTest {
    ...
    public void testCreateBooking_invalidBookingTimeRequest_shouldThrowItemIsUnavailable() {
        ...
        assertThrows(ItemIsUnavailableException.class, () -> bookingService.createBooking(bookingDto, booker.getId()));
    }
    ...
    public void testCreateBooking_unavailableItem_shouldThrowBadRequest() {
        ...
        assertThrows(BadRequestException.class, () -> bookingService.createBooking(bookingDto, booker.getId()));
    }
    ...
    public void testCreateBooking_shouldThrowInappropriateUser() {
        ...
        assertThrows(InappropriateUserException.class, () -> bookingService.createBooking(bookingDto, booker.getId()));
    }
    ...
    public void updateBookingStatus_withInappropriateUser_shouldThrowInappropriateUserException() {
        ...
        assertThrows(InappropriateUserException.class, () -> bookingService.updateBookingStatus(b1.getId(), newStatus, 999L));
    }
    ...
    public void updateBookingStatus_withRejectedBooking_shouldThrowBookingStatusAlreadySet() {
        ...
        assertThrows(BookingStatusAlreadySetException.class, () -> bookingService.updateBookingStatus(b1.getId(), newStatus, user.getId()));
    }
    ...
    public void getAllUserBookings_withInvalidStatus_shouldThrowUnsupportedStatus() {
        ...
        assertThrows(UnsupportedStatusException.class, () -> bookingService.getAllUserBookings(user.getId(), invalidStatus, "OWNER", 1, 2));
    }
    ...
    public void getAllUserBookings_withInvalidUserId_shouldThrowEntityNotFound() {
        ...
        assertThrows(EntityNotFoundException.class, () -> bookingService.getAllUserBookings(invalidUserId, invalidStatus, "OWNER", 1, 2));
    }
    ...
    public void getAllUserBookings_withInvalidPaginationRequest_shouldThrowBadRequest() {
        ...
        assertThrows(BadRequestException.class, () -> bookingService.getAllUserBookings(user.getId(), status, "USER", 0, 0));
    }
}