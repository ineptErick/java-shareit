...
class ItemRequestServiceImplIntegrationTest {
    ...
    void getRequestById_InvalidId_ThrowsEntityNotFound() {
        ...
        assertThrows(EntityNotFoundException.class, () -> itemRequestService.getRequestById(invalidId, user.getId()));
    }
    ...
    void getRequestById_InvalidUserId_ThrowsEntityNotFound() {
        ...
        assertThrows(EntityNotFoundException.class, () -> itemRequestService.getRequestById(requestId, invalidUserId));
    }
    ...
    void getOwnerRequests_withInvalidOwnerId_shouldThrowEntityNotFound() {
        ...
        assertThrows(EntityNotFoundException.class, () -> itemRequestService.getOwnerRequests(999L));
    }
