...
public class BookingServiceImpl implements BookingService {
    ...
    @Transactional(readOnly = true)
    public List<SentBookingDto> getAllUserBookings(int userId, String state, String userType) {
    ...
    @Transactional
    public SentBookingDto createBooking(ReceivedBookingDto bookingDto, int userId) {
    ...
    private void isValidBookingItemRequest(Item item, int userId) {
    ...
    private void isValidUpdateBookingStatusRequest(Booking booking, int userId, int bookingId) {
